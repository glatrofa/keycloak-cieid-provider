 ...
 * @author Pedro Igor
 */
public class CieIdIdentityProviderFactory extends AbstractIdentityProviderFactory<CieIdIdentityProvider> {
    ...
    public CieIdIdentityProviderConfig createConfig() {
        return new CieIdIdentityProviderConfig();
    }
        ...
        try {
            ...
            if (!choiceType.isEmpty()) {
                ...
                if (idpDescriptor != null) {
                    CieIdIdentityProviderConfig samlIdentityProviderConfig = new CieIdIdentityProviderConfig();
